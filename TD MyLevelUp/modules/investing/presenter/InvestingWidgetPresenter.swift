...
public class InvestingWidgetPresenter {
    public let intents: [InvestingIntent] = [WhyInvestingIntent(message: "We noticed you are spending quite heavily this month, see how investing instead of spending can grow your wealth"),
                          InvestingFinancialPlannerIntent(message: "It looks like you have more than $100,000, it's time for you to take advantage of our Financial Planners", buttonText: "Learn more"),
